...
use App\Models\DependenceDiscipline;
...
class DependenceDisciplineController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $matriculateds = DB::table("dependence_disciplines")
        ->select(
    ...
    public function show($id)
    {
        ...
        DependenceDiscipline::findOrFail($id);
    ...
    {
        $matriculated = DependenceDiscipline::findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        DependenceDiscipline::findOrFail($id)->delete();
