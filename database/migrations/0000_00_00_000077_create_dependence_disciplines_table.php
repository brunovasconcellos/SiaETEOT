...
class CreateDependenceDisciplinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dependence_disciplines', function (Blueprint $table) {
            $table->bigIncrements('dependence_id');
    ...
    {
        Schema::dropIfExists('dependence_disciplines');
    }
}
